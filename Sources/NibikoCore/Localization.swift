...
public enum LocalizationKey: String, CaseIterable, Sendable {
    ...
    case vaultNamePlaceholder
    case createNewVaultTitle
    case createNewVaultDescription
    case createVaultButton
    case openFolderAsVaultTitle
    case openFolderAsVaultDescription
    case openVaultButton
    case backButton
    case createLocalVaultTitle
    case vaultNameLabel
    case vaultNameHelp
    case vaultLocationLabel
    case browseButton
...
public struct Localizer: Sendable {
    ...
    private static let englishStrings: [LocalizationKey: String] = [
        ...
        .exitButton: "Exit",
        .exitConfirmationTitle: "Quit Nibiko?",
        ...
        .markdownStorageLocationLabel: "Storage Location",
        .chooseMarkdownStorageLocation: "Choose Location...",
        .markdownStorageLocationHelp: "Notes, todos, and reminders are saved in storage.md inside this storage folder.",
        .vaultNamePlaceholder: "Storage name",
        .createNewVaultTitle: "Create new storage",
        .createNewVaultDescription: "Create a new storage under this folder.",
        .createVaultButton: "Create",
        .openFolderAsVaultTitle: "Open storage location",
        .openFolderAsVaultDescription: "Choose the folder that contains your storages.",
        .openVaultButton: "Open",
        .backButton: "Back",
        .createLocalVaultTitle: "Create local storage",
        .vaultNameLabel: "Storage name",
        .vaultNameHelp: "Pick a name for your storage.",
        .vaultLocationLabel: "Location",
        .browseButton: "Browse",
    ...
    private static let germanStrings: [LocalizationKey: String] = [
        ...
        .exitButton: "Beenden",
        .exitConfirmationTitle: "Nibiko beenden?",
        ...
        .markdownStorageLocationLabel: "Speicherort",
        .chooseMarkdownStorageLocation: "Speicherort wählen...",
        .markdownStorageLocationHelp: "Notizen, Aufgaben und Erinnerungen werden in storage.md im Speicherordner gespeichert.",
        .vaultNamePlaceholder: "Speichername",
        .createNewVaultTitle: "Neuen Speicher erstellen",
        .createNewVaultDescription: "Erstelle einen neuen Speicher unter diesem Ordner.",
        .createVaultButton: "Erstellen",
        .openFolderAsVaultTitle: "Speicherort öffnen",
        .openFolderAsVaultDescription: "Wähle den Ordner, der deine Speicher enthält.",
        .openVaultButton: "Öffnen",
        .backButton: "Zurück",
        .createLocalVaultTitle: "Lokalen Speicher erstellen",
        .vaultNameLabel: "Speichername",
        .vaultNameHelp: "Wähle einen Namen für deinen Speicher.",
        .vaultLocationLabel: "Speicherort",
    ...
    private static let koreanStrings: [LocalizationKey: String] = [
        ...
        .settingsButton: "설정",
        .exitButton: "종료",
        .exitConfirmationTitle: "Nibiko를 종료할까요?",
        ...
        .markdownStorageLocationLabel: "저장 위치",
        .chooseMarkdownStorageLocation: "위치 선택...",
        .markdownStorageLocationHelp: "노트, 할 일, 리마인더는 저장 폴더 안의 storage.md에 저장됩니다.",
        .vaultNamePlaceholder: "저장소 이름",
        .createNewVaultTitle: "새 저장소 만들기",
        .createNewVaultDescription: "이 폴더 아래에 새 저장소를 만듭니다.",
        .createVaultButton: "만들기",
        .openFolderAsVaultTitle: "저장 위치 열기",
        .openFolderAsVaultDescription: "저장소들이 들어 있는 폴더를 선택합니다.",
        .openVaultButton: "열기",
        .backButton: "뒤로",
        .createLocalVaultTitle: "로컬 저장소 만들기",
        .vaultNameLabel: "저장소 이름",
        .vaultNameHelp: "저장소 이름을 선택합니다.",
        .vaultLocationLabel: "위치",
        .browseButton: "찾아보기",
    ...
    private static let chineseSimplifiedStrings: [LocalizationKey: String] = [
        ...
        .settingsButton: "设置",
        .exitButton: "退出",
        .exitConfirmationTitle: "退出 Nibiko？",
        ...
        .markdownStorageLocationLabel: "存储位置",
        .chooseMarkdownStorageLocation: "选择位置...",
        .markdownStorageLocationHelp: "笔记、待办和提醒会保存在存储文件夹内的 storage.md。",
        .vaultNamePlaceholder: "存储名称",
        .createNewVaultTitle: "新建存储",
        .createNewVaultDescription: "在此文件夹下创建新的存储。",
        .createVaultButton: "创建",
        .openFolderAsVaultTitle: "打开存储位置",
        .openFolderAsVaultDescription: "选择包含存储的文件夹。",
        .openVaultButton: "打开",
        .backButton: "返回",
        .createLocalVaultTitle: "创建本地存储",
        .vaultNameLabel: "存储名称",
        .vaultNameHelp: "为存储选择名称。",
        .vaultLocationLabel: "位置",
        .browseButton: "浏览",
